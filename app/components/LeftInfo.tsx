...
const LeftInfo = () => {
    return (
        <div className={'flex flex-col pt-[15px] w-fit'}>
            <div className={'flex  justify-center group cursor-pointer  items-center w-fit h-[220px]'}>
                <Image className={'w-[220px] p-[5px] overflow-hidden h-[205px] object-cover absolute'} width={220} height={205} src={emrelutfi} alt={'info bg'}/>

                <Image className={'group-hover:border-white  group-hover:border-opacity-[50%] w-[269px] h-[242px] cursor-pointer group-hover:border-[2px]'} width={269} height={242} src={infobg} alt={'info bg'}/>
            </div>
            <div className={'flex flex-col gap-[12px]'}>
                <div className={'mt-[30px] w-full flex justify-between items-start'}>
                    <div className={'flex flex-col'}>
                        ...
                        <h6 className={'text-basered  hover:text-white cursor-pointer   iceregular text-[24px]'}>
                            EmreLutfi
                        </h6>
                    </div>
                    <div className={'flex flex-col justify-end items-end gap-3'}>
                        <div className={'flex justify-end items-end flex-row gap-2'}>
                            <h6 className={'text-whitefont-regular  hover:text-white cursor-pointer text-[19px]'}>
                                Turkey
                            </h6>
                ...
                <div className={'flex flex-col '}>
                    ...
                    <div className={'w-full group relative cursor-pointer  h-[31px] '}>
                        <h6 className={'text-[24px] group-hover:text-white px-[5px] absolute uppercase text-black bigbold'}>
                            open for hire
                        </h6>
                        <Image width={269} height={242} src={openbg} alt={'info bg'}/>
                    </div>
                </div>
                <div className={'flex flex-col cursor-pointer'}>
                    ...
                    <div
                        ...
                        <svg className={'fill-[#E84A4A] group-hover:fill-white'} width="20" height="29" viewBox="0 0 20 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
